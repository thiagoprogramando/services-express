    ...
    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
        <div class="card mb-6">
            ...
            <div class="card-body pt-5">
                <form action="{{ route('created-template') }}" method="POST" class="tab-content p-0">
                    @csrf
                    <div class="tab-pane fade active show" id="navs-top-home" role="tabpanel">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                                <div class="form-floating form-floating-outline mb-2">
                                    <input type="text" class="form-control" name="name" id="name" placeholder="ex: Template financeiro"/>
                        ...
                        <div class="form-floating form-floating-outline mb-2">
                            <textarea class="form-control h-px-100" name="header" id="description"></textarea>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="navs-top-profile" role="tabpanel">
                        ...
                        <div class="form-floating form-floating-outline mb-2">
                            <textarea class="form-control h-px-100" name="footer" id="description"></textarea>
                        </div>
                        <div class="text-end">
